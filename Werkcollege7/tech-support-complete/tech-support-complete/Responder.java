...
public class Responder
{
    ...
    public String generateResponse(String[] words)
    {
        ...
        //int index = 0;
        //while (index < words.length && response == null) {
        //    response = responseMap.get(words[index]);
        //    ++index;
        //}
        
        for (int index = 0; index < words.length && response == null; ++index) {
            response = responseMap.get(words[index]);
        }
        
        if(response == null) { //couldnt find a response
